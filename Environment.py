...
class StochasticWindyGridworld:
    ...
    def __init__(self,initialize_model=True):
        ...
        self.goal_locations  = [[7,3]] #,[3,2]] # a vector specifying the goal locations in [[x1,y1],[x2,y2]] format
        self.goal_rewards    = [100,2] # a vector specifying the associated rewards with the goals in self.goal_locations, in [r1,r2] format
